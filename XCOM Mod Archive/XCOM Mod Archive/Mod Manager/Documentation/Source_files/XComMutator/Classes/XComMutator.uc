...
// Mutators loaded from checkpoint might have NextMutator set to a conflicting value (risk of recursive calls).
// Therefore during ApplyCheckpointRecord the existing chain of mutators must be rebuilt.
